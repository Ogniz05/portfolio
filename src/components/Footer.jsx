  ...
  return (
    <footer className="footer">
      <div className="container">
        <div className="footer__top">
          <a href="#" className="footer__logo">
            ...
            <span className="footer__logo-text">NP</span>
            <span className="footer__logo-bracket">]</span>
          </a>
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__meta">
            <p className="footer__copy">
              © {new Date().getFullYear()} Nicolò Persia. Costruito con React + Three.js
            </p>
            <p className="footer__made">
              Fatto con <span className="footer__heart">♥</span> in Italia
            </p>
          </div>
        </div>
      </div>
      ...
      <style>{`
        ...
        .footer__logo-text { color: var(--text); }
        .footer__nav {
          display: flex;
          gap: 28px;
          flex-wrap: wrap;
        ...
        .footer__nav-link:hover { color: var(--neon-blue); }
        .footer__socials {
          display: flex;
          gap: 12px;
        }
